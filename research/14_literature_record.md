# Literature Record — Models, Datasets, and Experimental Details

> **Role:** Factual catalog of Tier-1 and Tier-2 papers — models, datasets, signals, supervision, and reported results.  
> **Not:** gap analysis (see `03_literature_gap.md`) or Related Work prose.  
> **Evidence rule:** Every cell is traceable to the paper PDF / arXiv abstract+body as fetched 2026-06-20 (Tier-1 original five + Tier-2 batch) or 2026-06-22 (T1-06–08, T2-05, T2-13), or to `03` §2 deep-read notes. Do not cite this file for claims not in those sources.

> Related: `03_literature_gap.md` · `04_signal_design.md` · `claims.md`

---

## 1. Reading status

| Tier | ID | Paper | arXiv / venue | Status |
| ---- | -- | ----- | ------------- | ------ |
| 1 | T1-01 | RouteLLM — Ong et al. | [2406.18665](https://arxiv.org/abs/2406.18665) · ICLR 2025 | Deep read |
| 1 | T1-02 | FrugalGPT — Chen et al. | [2305.05176](https://arxiv.org/abs/2305.05176) · TMLR 2024 | Deep read |
| 1 | T1-03 | Hybrid LLM — Ding et al. | [2404.14618](https://arxiv.org/abs/2404.14618) · ICLR 2024 | Deep read |
| 1 | T1-04 | GraphRouter — Feng et al. | [2410.03834](https://arxiv.org/abs/2410.03834) · ICLR 2025 | Deep read |
| 1 | T1-05 | RouterBench — Hu et al. | [2403.12031](https://arxiv.org/abs/2403.12031) · ICML 2024 | Deep read |
| 1 | T1-06 | Smoothie — Guha et al. | [2412.04692](https://arxiv.org/abs/2412.04692) · NeurIPS 2024 | Deep read |
| 1 | T1-07 | CASCAL / RGD — Niu et al. | [2601.09692](https://arxiv.org/abs/2601.09692) · ACL 2026 | Deep read |
| 1 | T1-08 | UniRoute — Jitkrittum et al. | [2502.08773](https://arxiv.org/abs/2502.08773) · ICLR 2026 Poster | Deep read |
| 2 | T2-01 | Language Models (Mostly) Know What They Know — Kadavath et al. | [2207.05221](https://arxiv.org/abs/2207.05221) | Deep read |
| 2 | T2-02 | Uncertainty Calibration of Aligned LMs — He et al. | [2310.11732](https://arxiv.org/abs/2310.11732) | Deep read |
| 2 | T2-03 | Chat LLM Probabilities Miscalibrated but Predict Correctness — Plaut et al. | [2402.13213](https://arxiv.org/abs/2402.13213) | Deep read |
| 2 | T2-04 | Semantic Uncertainty — Kuhn et al. | [2302.09664](https://arxiv.org/abs/2302.09664) | Deep read |
| 2 | T2-06 | UCCI — Kotte et al. | [2605.18796](https://arxiv.org/abs/2605.18796) | Deep read (routing-adjacent) |
| 2 | T2-05 | CP-Router — Su et al. | [2505.19970](https://arxiv.org/abs/2505.19970) | Deep read (routing-adjacent) |
| 2 | T2-10 | LLMs Encode Their Failures — Lugoloobi et al. | [2602.09924](https://arxiv.org/abs/2602.09924) | Deep read (contrast) |
| 2 | T2-13 | Unsupervised RAG Query Routing — Mu et al. | [2501.07793](https://arxiv.org/html/2501.07793) | Deep read (retriever routing) |
| 2 | T2-07–09,11–12 | Farquhar, Self-Consistency, AutoMix, Guo, Kumar CP | not read | **Not read** — no rows below |

---

## 2. Master comparison — routing vs signal papers

| ID | Paper | Primary task | # models (typical) | Supervision | Signal timing | Uses H / margin as routing basis? | One LLM call / query? |
| -- | ----- | ------------ | ------------------ | ----------- | ------------- | --------------------------------- | --------------------- |
| T1-01 | RouteLLM | Strong vs weak class routing | 2 at eval (GPT-4, Mixtral-8x7B); 64 in train prefs | Human prefs + MMLU + GPT-4 judge | Pre-generation (query-only) | No | Yes |
| T1-02 | FrugalGPT | Budget-constrained QA | 12 APIs, cascade length 3 | Task labels → DistilBERT scorer | **Post-generation** per step | No | No (sequential cascade) |
| T1-03 | Hybrid LLM | Small vs large routing | 2 per experiment | BARTScore on offline gens | Pre-generation (query-only) | No | Yes |
| T1-04 | GraphRouter | Multi-LLM + multi-task | 10 LLMs | Historical query–LLM outcomes | Pre-generation (GNN, no live LLM probe) | No | Yes |
| T1-05 | RouterBench | Router **benchmark** | 11 (+ 3 RAG-only) | Precomputed outcomes | N/A (offline eval) | No (entropy only in cited cascade baselines elsewhere) | Depends on router |
| T2-01 | Kadavath | Self-eval / calibration | 800M–52B | P(IK) trained; P(True) uses samples | MC: pre-answer logits; open: needs draft | No (uncertainty study) | Yes |
| T2-02 | He | MC calibration | Llama 7B–70B, Vicuna, Llama-2-Chat | None for logit extraction | Pre-answer (MCQ logits) | No | Yes |
| T2-03 | Plaut | MC correctness prediction | 15 chat + base pairs | ~20 pts/dataset for abstention demo only | Pre-answer (MSP, max logit) | No | Yes |
| T2-04 | Kuhn | NLG uncertainty | OPT 2.7B–30B | Unsupervised clustering | **Multi-sample** generation | No | No (M samples) |
| T2-06 | UCCI | 4B↔12B cascade | 2 | Isotonic cal on held-out set | During small-model **generation** (token margin) | Margin **calibrated** for cascade | No (cascade) |
| T2-10 | Lugoloobi | Probe routing | 5–7 in routing demos | **Supervised** linear probes on activations | **Pre-generation** (hidden states) | No (activations, not logprobs) | Yes |
| T1-06 | Smoothie | Multi-LLM output selection | 4–11 per ensemble | **None** (weak-supervision graphical model) | **Post-generation** (all pool outputs) | No (output embeddings) | No (needs m gens/query) |
| T1-07 | CASCAL / RGD | Multi-LLM routing + aggregation | 6 per pool (2 pools) | **None** for correctness (consensus proxy) | **Post-generation** on training queries | No | No (pool responses on train) |
| T1-08 | UniRoute | Dynamic pool cost–quality routing | 30+ unseen at test | **Partial** — prompt K-means unsupervised; **Ψ(h) needs labeled val errors** | **Pre-generation** decision | No | Yes |
| T2-05 | CP-Router | LLM ↔ LRM binary route | 2 (pair) | **None** (CP; calibration split only) | **Pre-answer** (MCQ option logits) | Partial (CP set size, not H/margin) | Yes (one model forward for route) |
| T2-13 | Mu RAG routing | Search-engine selection for RAG | 3 engines | **None** for pseudo-labels (upper-bound construction) | **Pre-generation** at inference | No | Yes |

**Gap (this project):** Among rows above, none systematically study **unsupervised, model-dependent, pre-inference logprob probes** (entropy, margin) as the **primary** routing basis across a fixed **multi-LLM pool**. CP-Router (T2-05) is closest (pre-answer logits) but routes **LLM↔LRM pairs** via CP set size, not per-pool-member entropy/margin. See `03` §3.

---

## 3. Tier-1 — Routing and benchmark papers

### 3.0 Tier-1 at a glance

| ID | Training / construction data | Evaluation data | Eval model pair or pool | Router / method |
| -- | --------------------------- | --------------- | ----------------------- | --------------- |
| T1-01 | Chatbot Arena ~80k → 65k; + MMLU val ~1.5k; + Nectar/GPT-4 judge ~120k | MMLU, MT-Bench, GSM8K | GPT-4-1106-preview vs Mixtral-8x7B | SW ranking, MF, BERT, Llama-3-8B |
| T1-02 | HEADLINES, OVERRULING, COQA train splits | Same, test splits | 12 commercial APIs in learned cascade | DistilBERT g(q, answer), length-3 cascade |
| T1-03 | MixInstruct 10k train (+10 responses/model/query) | MixInstruct 5k test | e.g. Llama-2 7b↔13b, FLAN-T5, GPT-3.5-turbo | DeBERTa-v3-large |
| T1-04 | 600 queries × 4 tasks × 10 LLMs interaction graph | Same split 70/10/20 | 10 LLMs (Table 3.3 below) | Heterogeneous GNN + BERT |
| T1-05 | 405k precomputed (prompt, model) outcomes | Same benchmark | 11 LLMs × 8 datasets | KNN, MLP, Zero, cascade baselines |
| T1-06 | Unlabeled \(\mathcal{D}_{\text{test}}\); all \(m\) model generations per sample | 7 NLG + AlpacaEval + MixInstruct + GSM8K | 3B (4 LLMs), 7B (5 LLMs) ensembles | Smoothie-Global / Smoothie-Local (Algorithm 1) |
| T1-07 | RGD: synthetic \((\hat{q},\hat{a})\) from task descriptions; 5k/domain/generator | MMLU-Pro, MedMCQA, SuperGPQA, BBEH | Pool-Large (6), Pool-Small (6) | CASCAL (consensus + hierarchical clustering) |
| T1-08 | Train split + labeled \(S_{\text{val}}\) for per-cluster errors | EmbedLLM, RouterBench, Math+Code, SPROUT, Chatbot Arena | Train/test LLM pools disjoint; >30 unseen LLMs | UniRoute cluster-based (+ learned cluster map) |

---

### 3.1 T1-01 — RouteLLM (Ong et al., 2024/2025)
...
| **Tier assignment** | Models clustered into **10 tiers** (Chatbot Arena leaderboard + DP); strong = tiers 1–2, weak = tier 3 |
...
### 3.2 T1-02 — FrugalGPT (Chen et al., 2023)
...
### 3.3 T1-03 — Hybrid LLM (Ding et al., 2024)
...
### 3.4 T1-04 — GraphRouter (Feng et al., 2025)
...
### 3.5 T1-05 — RouterBench (Hu et al., 2024)
...
### 3.6 T1-06 — Smoothie (Guha et al., 2024)
...
### 3.7 T1-07 — CASCAL / Routing with Generated Data (Niu et al., 2026)
...
### 3.8 T1-08 — UniRoute (Jitkrittum et al., 2025/2026)
...
## 4. Tier-2 — Signal, calibration, and contrast papers

### 4.0 Tier-2 at a glance

| ID | Uncertainty statistic | When computed | Supervision | Primary datasets | Primary models |
| -- | --------------------- | ------------- | ----------- | ---------------- | -------------- |
| T2-01 | P(True), P(IK), MC calibration | MC logits pre-answer; P(True) needs samples | P(IK) classifier trained | MMLU, BIG-Bench MC, TriviaQA, Lambada, GSM8k, HumanEval, … | 800M, 3B, 12B, **52B** |
| T2-02 | MSP / logits on MCQ | Pre-answer (MCQ format) | None for extraction | HellaSwag, OpenbookQA, TruthfulQA, LogiQA, MMLU, CivilComments, IMDB | Llama 7B–70B, Vicuna, Llama-2-Chat |
| T2-03 | MSP, max logit (+ margin, entropy in appendix) | Pre-answer (MCQ) | ~20 labeled pts/dataset for abstention only | ARC, HellaSwag, MMLU, TruthfulQA, WinoGrande | 15 chat LMs + base variants |
| T2-04 | Semantic entropy | After **M** sampled answers | Unsupervised NLI clustering | TriviaQA, CoQA | OPT 2.7B–**30B** |
| T2-06 | Token margin → isotonic → P(error) | During small-model generation | Cal + val labels | Production NER (75k queries) | **4B** vs **12B** instruct |
| T2-10 | Linear probe on activations | **Pre-generation** (prefill) | Success labels from rollouts | E2H-AMC, GSM8K, MATH, AIME, LiveCodeBench | Qwen2.5-Math, GPT-OSS-20B, DeepSeek-R1-Distill, … |
| T2-05 | CP prediction set size (MCQ option softmax) | **Pre-answer** (MCQ logits) | CP calibration split only | MMLU-STEM, GPQA, LogiQA, CN-Chemistry, GSM8K | Llama-3.1-8B, Qwen-2.5-14B + Distill-R1 |
| T2-13 | BertScore + LLM coherence vs multi-source RAG upper bound | Label construction post-RAG; query-only router at inference | Pseudo-labels (no human gold) | NLPCC-MH, CDQA, WebQA, SogouQA, PrivateQA | Quark/Bing/Google; Qwen2-max, GPT-4 |

---

### 4.1 T2-01 — Kadavath et al. (2022)
...
| **Relevance** | Logprobs informative; P(True) is **not** pure prefill; chat vs base differs (see T2-02, T2-03) |

---

### 4.2 T2-02 — He et al. (2023)
...
| **Relevance** | Supports **ranking** by margin without calibrated probabilities (RH2) |
...
### 4.5 T2-06 — UCCI (Kotte et al., 2025)
...
### 4.6 T2-10 — Lugoloobi et al. (2026)
...
### 4.7 T2-05 — CP-Router (Su et al., 2025)
...
### 4.8 T2-13 — Unsupervised Query Routing for RAG (Mu et al., 2025)
...
| Dataset | Tier-1 papers | Tier-2 papers | This repo (code) |
| ------- | ------------- | ------------- | ---------------- |
| ARC-Challenge | RouterBench | Plaut | **Yes** (`prompt_protocol.py`) |
| GSM8K | RouteLLM, GraphRouter, RouterBench | Kadavath, Lugoloobi, **Smoothie (T1-06)**, **CP-Router (T2-05)** | **Yes** |
| MMLU-Pro / MedMCQA / SuperGPQA | — | **CASCAL (T1-07)** | No |
| EmbedLLM / RouterBench (dynamic pool) | RouterBench | **UniRoute (T1-08)** | RouterBench eval only |
| NLPCC-MH / CDQA / WebQA / SogouQA | — | **Mu RAG routing (T2-13)** | No |
...
| MBPP | RouterBench | — | No |
| MixInstruct | Hybrid LLM | **Smoothie (T1-06)** | No |
| Alpaca / SQuAD / Multi-News | GraphRouter | **Smoothie (T1-06)** | No |
...
| Qwen (1.5, 2.5-Math, 3) | GraphRouter; Lugoloobi; **CASCAL (T1-07)**; **CP-Router (T2-05)**; **this project C3/C4** |
| Llama-3.2 1B/3B Instruct | **This project C1/C2 (Gate 1 Exp 3)**; **CP-Router (T2-05)** Distill-Llama-8B |
| SentenceBERT / GTE / Gecko | **Smoothie (T1-06)**; **UniRoute (T1-08)** Gecko 1B; **Mu RAG (T2-13)** GTE-large |
...
| Token entropy / margin (prefill) | **This project 𝒮** | Yes (prefill branch) | No | No |
...
> **Role of this section:** Literature **informs** experimental design — it does **not** choose datasets or models. Decision order: research question → R1–R5 (`08` §5) → candidate triples → literature plausibility (here) → Phase A/B validation → lock (`09` D23).

### 6.1 How to use the literature map

| Do | Don't |
| -- | ----- |
| Check that a candidate setting appears in related uncertainty/routing work | Pick ARC because Plaut used it |
| Borrow **patterns** (same-family pool, MCQ pre-answer probes) | Reproduce GPT-4 / Mixtral / 70B pools |
| Cite prior work as **supporting evidence** in prose | Treat citation count as selection criterion |
| Use RouterBench dataset list as **sanity check** for plausible benchmarks | Run a benchmark suite because RouterBench has 8 datasets |

### 6.2 Dataset candidates — methodology first, literature second

| Priority | Dataset | Methodology reason (primary) | Literature support (secondary) | Project role |
| -------- | ------- | ---------------------------- | ------------------------------ | ------------ |
| 1 | **ARC-Challenge** | Objective MCQ; letter eval; low protocol risk for setup validation | T1-05 RouterBench; T2-03 Plaut (margin, entropy, MSP) | Phase B **candidate A**; in code |
| 2 | **MMLU (1–2 subjects)** | Same MCQ protocol; tests **cross-domain generalization** (science MCQ → knowledge MCQ) | T1-01 RouteLLM; T1-05; T2-01–03 | Phase B fallback or **Phase D** |
| 3 | HellaSwag / Winogrande | Different reasoning style; same probe interface | T1-05; T2-02 He; T2-03 Plaut | Phase D optional |
| 4 | GSM8K | Numeric reasoning; adds parsing complexity | T1-01, T1-04, T1-05; T2-01; T2-10 Lugoloobi | **Defer** — Qwen smoke too_hard; revisit after lock |
| — | MATH | Harder than GSM8K; activation-probe papers mainly | T2-10 Lugoloobi only | **Not v1** primary dataset |

**Not in this map (poor v1 fit):** HotpotQA, MuSiQue, GAIA, MMLU-Pro — multi-hop, agent, or harder variants; do not add without new R1–R5 analysis.

**Paper sentence (ARC):** ARC-Challenge is the strongest **initial candidate** because it satisfies experimental requirements and is widely used in closely related uncertainty work — not because it is the most popular benchmark.

### 6.3 Model pools — pattern from literature, IDs from hardware

| Literature pattern | Example in papers | This project |
| ------------------ | ----------------- | ------------ |
| Same-family weak ↔ strong | Llama-2 7B↔13B (T1-03); Llama 3 8B↔70B (T2-03) | Llama 3.2 **1B↔3B** (Phase B candidate A) |
| Same-family alternative | Qwen in T1-04, T2-10 | Qwen 1.5B↔3B (candidate C — ARC mostly easy) |
| Large proprietary pairs | GPT-4 vs Mixtral (T1-01) | **Not reproduced** — out of scope for hardware + RQ |

Literature justifies **two-tier same-family probing**, not specific checkpoint IDs.

### 6.4 Phase roadmap (literature-informed, validation-decided)

| Phase | Goal | Literature touchpoint |
| ----- | ---- | --------------------- |
| **A — Smoke** | Apparatus + H/m extraction | Plaut: pre-answer MC probes feasible |
| **B — Configuration** | Studiable outcome distribution | Hybrid LLM: need easy/hard spread between tiers |
| **C — Pilot** | ρ(entropy, margin vs oracle gap) | Plaut: AUROC without calibration; RH2 |
| **D — Generalization** | Second dataset (e.g. MMLU) | RouteLLM/RouterBench: multi-benchmark norm — **one** follow-on, not suite |
| **Routing (C6)** | Simple policy after characterization | Tier-1 baselines (always-small/large) — not reproducing learned routers |

### 6.5 Topic table (unchanged claims)

| Topic | Literature says | Our response (frozen elsewhere) |
| ----- | --------------- | ------------------------------- |
| **Research gap** | Tier-1 routes on supervised query/history/post-gen signals; label-free routing (Smoothie, CASCAL) is post-generation; UniRoute partial labels; CP-Router pre-answer but LLM↔LRM pair only | RQ in `00`; gap in `03` §3 |
| **Pilot signals** | H/m not primary routing signal in Tier-1 | D15: entropy + margin only (`09`) |
| **Chat vs base** | Plaut, He: chat MSP miscalibrated; format vs answer uncertainty | MCQ-style probes; document protocol version |
| **Ranking vs calibration** | Plaut: AUROC improves even when ECE poor | RH2: rank-based informativeness, not calibrated P(correct) |
| **Configuration failures** | Hybrid LLM: need spread of easy/hard queries between tiers | Qwen+ARC too easy; GSM8K too hard — triple (pool, dataset, protocol) |
| **Oracle / metrics** | RouterBench oracle, AIQ, Zero router | `07`, `08` |
| **Run record fields** | RouterBench precomputes (prompt, model, outcome) | Pool + dataset + `protocol_version` + `prompt_hash` per run |
| **Operating model** | — | Phases A–D (`claims` §Operating model, D21–D23) |

---

## 7. Experiment documentation checklist (from literature + phases)

Record on every Phase A / B / C / D run:

| Field | Example / source |
| ----- | ---------------- |
| Configuration triple | pool + dataset + `protocol_version` |
| Phase B candidate ID | A / B / C (`08` §8) |
| Models | HF id + revision if pinned (RouterBench reproducibility norm) |
| Dataset | name, split, n, seed |
| Generation | `max_new_tokens`, decoding params |
| Phase B buckets | easy / weak-only / strong-only / too-hard / opportunity rate |
| Phase B suitability | distribution diversity judgment (`08` §8.2) — not a single rate threshold |
| Failure mode tag | `too_easy` \| `too_hard` \| `mixed` |
| Paths | raw JSON/CSV under `experiments/`; summary under `analysis/` |
| Phase A / signal rows | H, m, max_prob, vocab_size; degeneracy checks — **no ρ claims** until Phase C |
| Prompt audit | `user_content`, `prompt_hash`, `tokenizer_id` |
| Phase D note | primary vs generalization dataset; hypothesis extended |

---

## 8. Papers not yet recorded here

Per literature tracker in this file — **do not fill rows from memory:**

| ID | Paper |
| -- | ----- |
| T2-07 | Detecting Hallucinations via Semantic Entropy — Farquhar et al. |
| T2-08 | Self-Consistency — Wang et al. |
| T2-09 | AutoMix — Madaan et al. |
| T2-11 | On Calibration of Modern Neural Networks — Guo et al. |
| T2-12 | Conformal Prediction for MCQA — Kumar et al. |
...
| Event | Action |
| ----- | ------ |
| Deep-read T2-07–09, 11–12 | Add §4.x sections; update §1 status and §5 indexes |
| Deep-read T1-06–08, T2-05, T2-13 | **Done 2026-06-22** — §3.6–3.8, §4.7–4.8; `03` §2.6–2.11 |
| Gate 1 Exp 3 (Llama ARC) | Add row to §5.1 / project notes in `notes.md`, not duplicate raw results here |
| Pilot pool frozen in `09` | Add “This project locked config” subsection with pinned revisions |
| New Tier-1 routing paper | Add T1 row; update §2 master table and `03` §2 |

*Last updated: 2026-06-22 — added T1-06 (Smoothie), T1-07 (CASCAL/RGD), T1-08 (UniRoute), T2-05 (CP-Router), T2-13 (Mu RAG); arXiv full text fetch.*
